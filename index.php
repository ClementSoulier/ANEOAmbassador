...
<hr style="width:320px">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h1 class="chubby">Qui est ANEO ?</h1>
        </div>
    </div>
    <br/><br/>
    <div>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h1 class="chubby">Programme<br/>Ambassador</h1>
        </div>
    </div>
    <br/><br/>
    <div>
        <div class="row text-center">
            <!-- Programme Row -->
            <div id="bloctitle_programme_colleft" class="col-md-4 col-md-offset-2">
                <h3 id="title_programme_colleft" class="din">C'est quoi</h3>
            </div>
            <div id="bloctitle_programme_colright" class="col-md-4">
                <h3 id="title_programme_colright" class="din">Des privilèges</h3>
            </div>
            <div style="height: 5px;" class="col-md-8 col-md-offset-2 white_background">
            </div>
        </div>
    </div>
    <div class="margin_top">
        <div class="row text-center">
            ...
            <div style="height: 550px;" id="programme_colleft" class="col-md-4 col-md-offset-2">
                <div class="arrow_box">
                    ...
                    <h5 class="din margin_top">Tout au long de l'année tu auras pour mission de développer la marque
                        ANEO dans ton école, organiser des événements et participer à l'actualité d'ANEO sur ton campus.</h5>
                    <h4 class="chubby margin_top">Quels sont les objectifs d'un ambassadeur ?</h4>
                    <h5 class="din margin_top">Être le relais d'ANEO au sein de son école et incarner les valeurs
                        d'ANEO.</h5>
                    <h4 class="chubby margin_top">Qui peut devenir ambassadeur ?</h4>
            ...
            <div style="height: 550px;" id="programme_colright" class="col-md-4">
                ...
                <h5 class="din margin_top">L'opportunité de participer à un séminaire d'intégration pour les ambassadeurs
                    2017.</h5>
                <h5 class="din">Une rémunération</h5>
                <h5 class="din">Un accès à un réseau de profesionnels, pour tes stages et ta première embauche.</h5>
                <h5 class="din">Un budget alloué pour organiser des événements ANEO dans ton école.</h5>
                <h4 class="chubby margin_top">Mais surtout :</h4>
                <h5 class="din margin_top">Vivre une expérience unique et faire partie de la communauté ANEO!</h5>
            </div>
        </div>
    </div>
    <br/><br/><br/><br/><br/>
    ...
    <div class="row text-center">
        ...
        <div style="height: 250px;" class="col-md-4 darkgrey_background">
            ...
            <a href="https://fr.linkedin.com/company/aneo" target="_blank"><img class="icone" src="img/elements/LINKEDIN.png"/></a>
...
<script>
    $('#programme_colleft').hover(function () {
        jQuery(this).animate({
            backgroundColor: "#EC9306"
        }, 200);
        jQuery('#title_programme_colleft').animate({
            color: "#303030"
        }, 200);
        jQuery('#bloctitle_programme_colleft').animate({
    ...
    $('#programme_colright').hover(function () {
        jQuery(this).animate({
            backgroundColor: "#EC9306"
        }, 200);
        jQuery('#title_programme_colright').animate({
            color: "#303030"
        }, 200);
        jQuery('#bloctitle_programme_colright').animate({
            backgroundColor: "White"
        }, 200);
    }, function () {
        jQuery(this).animate({
